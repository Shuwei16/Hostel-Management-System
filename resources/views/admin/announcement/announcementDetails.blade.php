...
@section('content')
    ...
    <h1>Announcements Details <a class="btn btn-danger" href="" title="Delete Annoucement" style="font-size: 1vmax; float: right;"><i class="fa fa-trash-o" aria-hidden="true"></i> Delete</a> <a class="btn btn-primary" href="admin-editAnnouncement" title="Edit Annoucement" style="font-size: 1vmax; float: right; margin-right: 10px"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a></h1>
