...
@section('content')
    <a class="btn btn-secondary" href="resident-vehicleParkingPassDetails" title="Back to Vehicle Parking Pass Application Details"><i class="fa fa-angle-left" aria-hidden="true"></i> Back</a><br><br>
