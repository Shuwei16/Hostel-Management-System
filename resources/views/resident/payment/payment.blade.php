...
@section('content')
    ...
    <a class="btn btn-secondary" href="{{route('resident-registrationDetails', ['id'=>$id])}}" title="Back to Registration Approval"><i class="fa fa-angle-left" aria-hidden="true"></i> Back</a><br><br>
    <h1>Payment</h1><br>
    ...
    <form class="input-form" action="{{route('resident-payment-method')}}" method="post">
        @csrf
