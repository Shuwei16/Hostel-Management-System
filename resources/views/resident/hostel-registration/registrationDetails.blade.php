    ...
    <table class="table table-details">
        ...
        <tr>
            ...
            <td>
                @if($registration->status == "Pending Payment")
                    <!--Make Payment Button-->
                    <button type="button" class="btn btn-info btn-sm btn-action" onclick="window.location.href = '{{route('resident-payment', ['id'=>$registration->registration_id])}}'">Make Payment <i class="fa fa-arrow-right" aria-hidden="true"></i></button>
                ...
                @elseif($registration->status == "Failed" || $registration->status == "Canceled" || $registration->status == "Payment Failed")
                    <!--Re Apply Button-->
                    <button type="button" class="btn btn-info btn-sm btn-action" onclick="window.location.href = 'resident-extensionRegistration'">Apply Again <i class="fa fa-arrow-right" aria-hidden="true"></i></button>
