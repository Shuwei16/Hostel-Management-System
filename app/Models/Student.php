...
class Student extends Model
{
    ...
    protected $fillable = ['user_id', 'ic', 'student_card_no', 'resident_id', 'contact_no', 'gender', 'race', 'citizenship', 'programme', 'total_year', 'current_year', 'study_semester', 'address', 'emergency_contact_name', 'emergency_contact_no'];
